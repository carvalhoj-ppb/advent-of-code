...
const Replace = List.map((ex) => {
    return ex.replace(/twone/g, '21')
...
const ArrNumber = Replace.map((grp) => {
    return grp[0] + grp[grp.length-1]
}).map(Number);

const SumOfAll = ArrNumber.reduce((acc, val) =>  acc + val, 0)

console.log(SumOfAll)

//console.log(ArrayNumberFake)